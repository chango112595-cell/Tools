...
# Step 2: Navigate to directory & give permissions
cd hackingtool
chmod -R 755 hackingtool

# Step 3: Run installer (requires root)
sudo bash install.sh

# Step 4: Launch HackingTool
sudo hackingtool
```
...
Start the modern web interface for an easy-to-use graphical experience:
```bash
python3 app.py
```
...
## 📟 Terminal Mode (Classic Interface)
